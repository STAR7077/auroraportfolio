    ...
    try {
      ...
      emailjs.sendForm(
        ...
        (response) => {
          ...
          if (language === "JP") {
            toast.success(toastMessages.successEmailSent.jp);
          } else {
        ...
        (error) => {
          ...
          if (language === "JP") {
            toast.error(toastMessages.failedEmailSent.jp);
          } else {
        ...
        >
          ...
          >
            <p className="text-[--black] mb-6">
              ...
              {language === "JP" ? contactData.title.jp : contactData.title.en}
              <span className="text-[--orange]">/&gt;</span>
            </p>

            <h2 className="text-[--black] text-center">
              {language === "JP"
                ? contactData.description.jp
        ...
        <div className="flex flex-row justify-center items-start px-32 pt-32 mb-32 max-lg:flex-col max-lg:p-10">
          ...
          >
            ...
            <textarea
              ...
              placeholder={
                language === "JP"
                  ? `${contactData.textarea.placeholder.jp}`
            ...
            {/* <div className="privacy-checkbox flex gap-16">
              ...
              <p>
                {language === "JP"
                  ? `${contactData.privacyOptIn.checkbox.jp}`
                  : `${contactData.privacyOptIn.checkbox.en}`}
              </p>
            </div> */}
            {/* <p>
              {language === "JP"
                ? `${contactData.privacyOptIn.description.jp}`
                : `${contactData.privacyOptIn.description.en}`}
            </p> */}
            <Button
              value={
                language === "JP"
                  ? `${contactData.button.value.jp}`
